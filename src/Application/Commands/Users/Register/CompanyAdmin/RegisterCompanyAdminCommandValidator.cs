...
internal class RegisterCompanyAdminCommandValidator : AbstractValidator<RegisterCompanyAdminCommand>
{
    public RegisterCompanyAdminCommandValidator()
    {
        ...
        RuleFor(x => x.CompanyEmail)
            ...
            .MaximumLength(Email.MaxLength).WithMessage($"Company email must not exceed {Email.MaxLength} characters.");

        RuleFor(x => x.CompanyName)
            .NotEmpty().WithMessage("Company name is required.")
            .MaximumLength(Company.MaxNameLength).WithMessage($"Company name must not exceed {Company.MaxNameLength} characters.");
