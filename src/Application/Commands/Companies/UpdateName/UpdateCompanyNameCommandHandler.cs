...
internal sealed class UpdateCompanyNameCommandHandler : ICommandHandler<UpdateCompanyNameCommand>
{
    ...
    public UpdateCompanyNameCommandHandler(ICompanyRepository companyRepository, IUnitOfWork unitOfWork, IUserContext userContext, ICompanyUserRepository companyUserRepository)
    {
