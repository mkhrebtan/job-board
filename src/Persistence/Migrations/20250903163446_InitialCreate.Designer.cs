...
namespace Persistence.Migrations
{
    ...
    [Migration("20250903163446_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Contexts.IdentityContext.Entities.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Contexts.ResumePostingContext.Aggregates.Resume", b =>
                {
                    ...
                    b.Property<IReadOnlyCollection<EmploymentType>>("EmploymentTypes")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<IReadOnlyCollection<WorkArrangement>>("WorkArrangements")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Domain.Contexts.IdentityContext.Aggregates.RefreshToken", b =>
                {
                    b.HasOne("Domain.Contexts.IdentityContext.Entities.Account", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Contexts.IdentityContext.Entities.Account", b =>
                {
                    b.HasOne("Domain.Contexts.IdentityContext.Aggregates.User", null)
                        .WithOne("Account")
                        .HasForeignKey("Domain.Contexts.IdentityContext.Entities.Account", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
