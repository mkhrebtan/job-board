...
internal sealed class ResumeConfiguration : IEntityTypeConfiguration<Resume>
{
    public void Configure(EntityTypeBuilder<Resume> builder)
    {
        ...
        builder.ComplexProperty(r => r.PersonalInfo, personalInfoBuilder =>
        {
        ...
        builder.ComplexProperty(r => r.Location, locationBuilder =>
        {
        ...
        builder.ComplexProperty(r => r.ContactInfo, contactInfoBuilder =>
        {
            ...
            contactInfoBuilder.ComplexProperty(ci => ci.PhoneNumber, phoneBuilder =>
            {
        ...
        builder.ComplexProperty(r => r.SalaryExpectation, salaryBuilder =>
        {
            salaryBuilder.Property(s => s.Currency).IsRequired();
            salaryBuilder.Property(s => s.Value).IsRequired();
        });

        builder.ComplexProperty(r => r.SkillsDescription, summaryBuilder =>
        {
